...
This document is for Openshift version 4.8 and CoreOS 4.8. If you are installing Openshift version 4.7 please refer to ocp47 branch
...
* Download OCP48 OVA from Redhat site and import it. Specify **api-vlan-portgroup** as the port group for network interface.
