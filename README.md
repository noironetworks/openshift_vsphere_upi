...
This document is for Openshift version 4.19 and CoreOS 4.19. If you are installing Openshift version 4.18 please refer to ocp418 branch

## Step 1 - acc-provision
* Provision ACI fabric using acc-provision utility. 

  * Specify the flavor parameter value as 'openshift-4.19-esx'.
...
* Download OCP419 OVA from Redhat site and import it. Specify **api-vlan-portgroup** as the port group for network interface.
