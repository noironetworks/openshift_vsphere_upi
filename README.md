...
If you have restrictions on the use of DHCP in your environment, access this directory (Docs -> openshift_vsphere_upi_without_DHCP) to provide this integration without DHCP, using VMware guestinfo.afterburn.initrd.network-kargs.
